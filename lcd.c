...
temp=(LCD_DATA_PORT & (~((1<<LCD_DATA_D7)|(1<<LCD_DATA_D6)|(1<<LCD_DATA_D5)|(1<<LCD_DATA_D4))))|(hn<<LCD_DATA_D4);
LCD_DATA_PORT=temp;
...
temp=(LCD_DATA_PORT & (~((1<<LCD_DATA_D7)|(1<<LCD_DATA_D6)|(1<<LCD_DATA_D5)|(1<<LCD_DATA_D4))))|(ln<<LCD_DATA_D4);
LCD_DATA_PORT=temp;
...
void LCDBusyLoop()
{
	...
	LCD_DATA_DDR &= ~((1<<LCD_DATA_D7)|(1<<LCD_DATA_D6)|(1<<LCD_DATA_D5)|(1<<LCD_DATA_D4));
	...
	do
	{
		...
		temp =LCD_DATA_PIN;
		temp &= (1<<LCD_DATA_D7)|(1<<LCD_DATA_D6)|(1<<LCD_DATA_D5)|(1<<LCD_DATA_D4);
...
void InitLCD(uint8_t style)
{
	...
	*****************************************************************/
	...
	//LCD_DATA_PORT&=0XF0;
	LCD_DATA_PORT &= ~((1<<LCD_DATA_D7)|(1<<LCD_DATA_D6)|(1<<LCD_DATA_D5)|(1<<LCD_DATA_D4));
	CLEAR_E();
	CLEAR_RW();
	CLEAR_RS();
	...
	SET_E();
	LCD_DATA_PORT|=(0b00000010 << LCD_DATA_D4); //[B] To transfer 0b00100000 i was using LCD_DATA_PORT|=0b00100000
	_delay_us(1);
	CLEAR_E();
	_delay_us(1);
